...
const taskEditTemplate = (key, task) => `
                <input type="text" name="projectText" id="projectText" placeholder="Project" value="${task.project}">
...
function listProjects(projects) {
    projectList.innerHTML = projects.map(prj=>`<li class="li-project">${prj}</li>`).join('')
}
...
export { displayTodoList, listProjects, bindUpdateHandler, bindDeleteGetHandler, bindNewHandler, bindProjectHandler, bindTimeHandler}